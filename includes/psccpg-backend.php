                                       	...
                                       	<div class="post_option" id="post_title_option" style="display: none">
                                            <ul>
                                                ...
                                                <li>
    	                                            <?php
                                                    if(!empty($posttitledata)){
                                                        $ocpc_posttitleposition_dval = $posttitledata['ocpc_posttitleposition'];
                                                    }else{
                                                ...
                                                <li>
    	                                            <?php
                                                    if(!empty($posttitledata)){
                                                        $ocpc_posttitlefweight_dval = $posttitledata['ocpc_posttitlefweight'];
                                                    }else{
                                ...
                                <tr valign="top">
                                    ...
                                    <td class="forminp forminp-text">
                                        <div class="post_option" id="post_date_option" style="display: none">
                                            <ul>
                                                <?php
                                                if(!empty($postdatedata)){
                                                    $postdatecolor_dval = $postdatedata['ocpc_postdatecolor'];
                                                }else{
                                                ...
                                                <?php
                                                if(!empty($postdatedata)){
                                                    $postdateposition_dval = $postdatedata['ocpc_postdateposition'];
                                                }else{
                                                ...
                                                <?php
                                                if(!empty($postdatedata)){
                                                    $postdatefweight_dval = $postdatedata['ocpc_postdatefweight'];
                                                }else{
                                                    $postdatefweight_dval = 'Left';
                                                }
                                                ?>
                                                <li><select name="ocpc-postdatefweight">
                                                        <option value="Normal"  <?php if($postdatefweight_dval == 'Normal'){echo "selected";} ?>><?php echo __( 'Normal', PSCCPG_DOMAIN );?></option>
                                                        <option value="Bold"  <?php if($postdatefweight_dval == 'Bold'){echo "selected";} ?>><?php echo __( 'Bold', PSCCPG_DOMAIN );?></option>
                                                    </select>
                                                </li>
                                            </ul>
                                        </div>
                                ...
                                <tr valign="top" class="ocpc_plchldr_tr">
                                    ...
                                    <td class="forminp forminp-text">
                                        <?php
                                            ...
                                            if (!empty($ocpc_placeholderimage_array)) {
